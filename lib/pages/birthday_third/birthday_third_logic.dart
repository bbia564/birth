...
import 'package:birthday_record/pages/birthday_first/birthday_first_logic.dart';
...
class BirthdayThirdLogic extends GetxController {
  ...
  cleanBirthdayData() async {
    Get.dialog(AlertDialog(
      ...
      actions: [
        ...
        TextButton(
          onPressed: () async {
            await dbBirthday.cleanBirthdayData();
  ...
  aboutBirthdayPrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutBirthdayUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can record your family member's birthday"""),
      ],
      context: context,
    );
  }
